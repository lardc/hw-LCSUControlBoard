...
//
#define REG_ADC_VOLTAGE_K				24	// Измерение напряжения на батарее, пропорциональный коэффициент K
#define REG_ADC_VOLTAGE_B				25	// Измерение напряжения на батарее, коэффициент cмещения B
//
#define REG_K_AMP_RANGE0				26	// Коэффициент усиления тока в канале 0
#define REG_K_AMP_RANGE1				27	// Коэффициент усиления тока в канале 1
//
#define REG_ADC_I_RANGE0_P2				30	// Диапазон 0 - Коэффициент тонкой подстройки Р2
#define REG_ADC_I_RANGE0_P1				31	// Диапазон 0 - Коэффициент тонкой подстройки Р1
#define REG_ADC_I_RANGE0_P0				32	// Диапазон 0 - Смещение тонкой подстройки Р0
#define REG_ADC_I_RANGE0_K				33	// Диапазон 0 - Коэффициент грубой подстройки K
#define REG_ADC_I_RANGE0_B				34	// Диапазон 0 - Смещение грубой подстройки B
//
#define REG_ADC_I_RANGE1_P2				35	// Диапазон 1 - Коэффициент тонкой подстройки Р2
#define REG_ADC_I_RANGE1_P1				36	// Диапазон 1 - Коэффициент тонкой подстройки Р1
#define REG_ADC_I_RANGE1_P0				37	// Диапазон 1 - Смещение тонкой подстройки Р0
#define REG_ADC_I_RANGE1_K				38	// Диапазон 1 - Коэффициент грубой подстройки K
#define REG_ADC_I_RANGE1_B				39	// Диапазон 1 - Смещение тонкой подстройки B
//
#define REG_REGULATOR_RANGE0_Kp			40	// Диапазон 0 - Пропорциональный коэффициент регулятора
#define REG_REGULATOR_RANGE0_Ki			41	// Диапазон 0 - Интегральный коэффициент регулятора
